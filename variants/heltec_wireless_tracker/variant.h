...
#define ST7735_VTFT_CTRL_Pin 3 // active HIGH, powers the TFT baclkight and lora antenna boost
...
#define VEXT_ENABLE_V05 ST7735_VTFT_CTRL_Pin // active HIGH, powers the TFT baclkight and lora antenna boost
#define BUTTON_PIN 0
